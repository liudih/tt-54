$(document).ready(function() {	
	...
	var submithandler = function(form){
		disableSaveBtn(true);
		$.get(jsRoute.controllers.manager.luckdraw.PageQualificationAction.validate().url,{ipageid:form.ipageid.value},function(data){
	...
	$("#add_btn").click(function(){
		$('#addform').form('clear').attr({'action':jsRoute.controllers.manager.luckdraw.PageQualificationAction.add().url,formtype:'add'});
	...
	$(".edit").click(function() {
		...
		$('#addform').form('clear').attr({'action':jsRoute.controllers.manager.luckdraw.PageQualificationAction.save().url,formtype:'edite'});
