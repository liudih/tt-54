...
public class FoundationService {
	...
	public static final String DEVICE_NAME = "web";
	...
	public String getCurrency() {
		Context httpCtx = Context.current();
		String curr = CookieUtils.getCookie(COOKIE_CURRENCY, httpCtx);
		...
		if (loginContext != null && loginContext.getCurrencyCode() != null) {
			String cc = loginContext.getCurrencyCode();
			this.setCurrency(cc);
			return cc;
		}
		WebContext webCtx = ContextUtils.getWebContext(httpCtx);
	...
	public void setCurrency(String ccy) {
		Context httpCtx = Context.current();
		CookieUtils.setCookie(COOKIE_CURRENCY, ccy, httpCtx);
		LoginContext loginContext = getLoginContext();
		loginContext.setCurrencyCode(ccy);
	...
	public void setCountry(String countryCode) {
		LoginContext loginContext = getLoginContext();
		loginContext.setCountryCode(countryCode);
		setLoginContext(loginContext);
	}
