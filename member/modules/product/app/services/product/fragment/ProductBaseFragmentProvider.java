...
public class ProductBaseFragmentProvider implements IProductFragmentProvider {
	...
	public IProductFragment getFragment(ProductContext context,
		...
		ProductBase base = productBaseMapper
				.getProductBaseByListingIdAndLanguage(context.getListingID(),
						context.getLang());
		List<ProductExplain> productExplains = productExplainEnquityDao
