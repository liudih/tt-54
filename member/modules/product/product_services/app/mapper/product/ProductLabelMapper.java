...
public interface ProductLabelMapper {
	...
	@Select("select count(*) from t_product_label where iwebsiteid = #{siteId} and ctype = #{type}")
	int getProductLabelCountByTypeAndWebsite(@Param("siteId")int siteId, @Param("type")String type);
