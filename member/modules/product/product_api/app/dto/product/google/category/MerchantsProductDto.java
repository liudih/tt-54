...
public class MerchantsProductDto implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 5666280758653025006L;
	...
	public String toString() {
		return "MerchantsProductDto [iid=" + iid + ", clistingid=" + clistingid
				+ ", csku=" + csku + ", ctitle=" + ctitle + ", cdescription="
				+ cdescription + ", iwebsiteid=" + iwebsiteid + ", ilanguage="
				+ ilanguage + ", icount=" + icount + ", cchannel=" + cchannel
				+ ", productprice=" + productprice + ", ctargetcountry="
				+ ctargetcountry + ", ccountrycurrency=" + ccountrycurrency
				+ ", clanguage=" + clanguage + ", googlecategory="
				+ googlecategory + ", cpath=" + cpath + ", cname=" + cname
				+ ", customLabel1=" + customLabel1 + ", cstate=" + cstate
				+ ", cresult=" + cresult + ", cfaultreason=" + cfaultreason
				+ ", createuser=" + createuser + ", cnodedata=" + cnodedata
				+ ", cnodeid=" + cnodeid + ", attributes=" + attributes
				+ ", shippingprice=" + shippingprice + ", dpulldate="
				+ dpulldate + ", dpushdate=" + dpushdate + ", dcreatedate="
				+ dcreatedate + ", dupdatedate=" + dupdatedate + "]";
	}
