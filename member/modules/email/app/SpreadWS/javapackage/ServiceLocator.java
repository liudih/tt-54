...
public class ServiceLocator extends org.apache.axis.client.Service implements SpreadWS.javapackage.Service {
    ...
    private java.lang.String ServiceSoap_address = "http://service.rspread.com/Service.asmx";
    ...
    public SpreadWS.javapackage.ServiceSoap getServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            SpreadWS.javapackage.ServiceSoapStub _stub = new SpreadWS.javapackage.ServiceSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (SpreadWS.javapackage.ServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                SpreadWS.javapackage.ServiceSoapStub _stub = new SpreadWS.javapackage.ServiceSoapStub(new java.net.URL(ServiceSoap_address), this);
                _stub.setPortName(getServiceSoapWSDDServiceName());
                return _stub;
            }
        }
