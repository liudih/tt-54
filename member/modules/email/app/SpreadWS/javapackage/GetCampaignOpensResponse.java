...
public class GetCampaignOpensResponse  implements java.io.Serializable {
    private SpreadWS.javapackage.GetCampaignOpensResponseGetCampaignOpensResult getCampaignOpensResult;

    public GetCampaignOpensResponse() {
    }

    public GetCampaignOpensResponse(
           SpreadWS.javapackage.GetCampaignOpensResponseGetCampaignOpensResult getCampaignOpensResult) {
     ...
     */
    public SpreadWS.javapackage.GetCampaignOpensResponseGetCampaignOpensResult getGetCampaignOpensResult() {
        return getCampaignOpensResult;
    }
     ...
     */
    public void setGetCampaignOpensResult(SpreadWS.javapackage.GetCampaignOpensResponseGetCampaignOpensResult getCampaignOpensResult) {
        this.getCampaignOpensResult = getCampaignOpensResult;
    }
