 ...
 * @author Yaniv Inbar
 */
public abstract class AbstractGoogleClientBack {

  static final Logger LOGGER = Logger.getLogger(AbstractGoogleClientBack.class.getName());
   ...
   * none.
   */
  private final GoogleClientRequestInitializerBack googleClientRequestInitializer;
   ...
   * @since 1.14
   */
  protected AbstractGoogleClientBack(Builder builder) {
  ...
  public final GoogleClientRequestInitializerBack getGoogleClientRequestInitializer() {
   ...
   */
  protected void initialize(AbstractGoogleClientRequestBack<?> httpClientRequest) throws IOException {
  ...
  public abstract static class Builder {
    ...
    public abstract AbstractGoogleClientBack build();
