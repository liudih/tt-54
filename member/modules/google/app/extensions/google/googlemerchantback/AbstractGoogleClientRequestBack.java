 ...
 * @author Yaniv Inbar
 */
public abstract class AbstractGoogleClientRequestBack<T> extends GenericData {
  ...
  /** Google client. */
  private final AbstractGoogleClientBack abstractGoogleClient;
   ...
   */
  protected AbstractGoogleClientRequestBack(AbstractGoogleClientBack abstractGoogleClient,
   ...
   * </p>
   */
  public AbstractGoogleClientRequestBack<T> setDisableGZipContent(boolean disableGZipContent) {
   ...
   * </p>
   */
  public AbstractGoogleClientBack getAbstractGoogleClient() {
   ...
   * </p>
   */
  public AbstractGoogleClientRequestBack<T> setRequestHeaders(HttpHeaders headers) {
  ...
  @Override
  public AbstractGoogleClientRequestBack<T> set(String fieldName, Object value) {
    return (AbstractGoogleClientRequestBack<T>) super.set(fieldName, value);
  }
