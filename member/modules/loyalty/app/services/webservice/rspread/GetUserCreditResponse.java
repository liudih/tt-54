...
public class GetUserCreditResponse  implements java.io.Serializable {
    private services.webservice.rspread.GetUserCreditResponseGetUserCreditResult getUserCreditResult;

    public GetUserCreditResponse() {
    }

    public GetUserCreditResponse(
           services.webservice.rspread.GetUserCreditResponseGetUserCreditResult getUserCreditResult) {
     ...
     */
    public services.webservice.rspread.GetUserCreditResponseGetUserCreditResult getGetUserCreditResult() {
        return getUserCreditResult;
    }
     ...
     */
    public void setGetUserCreditResult(services.webservice.rspread.GetUserCreditResponseGetUserCreditResult getUserCreditResult) {
        this.getUserCreditResult = getUserCreditResult;
    }
