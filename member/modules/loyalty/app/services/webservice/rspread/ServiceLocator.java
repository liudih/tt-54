...
public class ServiceLocator extends org.apache.axis.client.Service implements services.webservice.rspread.Service {
    ...
    private java.lang.String ServiceSoap_address = "http://service.reasonablespread.com/service.asmx";
    ...
    public services.webservice.rspread.ServiceSoap getServiceSoap() throws javax.xml.rpc.ServiceException {
    ...
    public services.webservice.rspread.ServiceSoap getServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            services.webservice.rspread.ServiceSoapStub _stub = new services.webservice.rspread.ServiceSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (services.webservice.rspread.ServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                services.webservice.rspread.ServiceSoapStub _stub = new services.webservice.rspread.ServiceSoapStub(new java.net.URL(ServiceSoap_address), this);
                _stub.setPortName(getServiceSoapWSDDServiceName());
                return _stub;
            }
        }
