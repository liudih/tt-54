...
public class GetCampaignAbusesResponse  implements java.io.Serializable {
    private services.webservice.rspread.GetCampaignAbusesResponseGetCampaignAbusesResult getCampaignAbusesResult;

    public GetCampaignAbusesResponse() {
    }

    public GetCampaignAbusesResponse(
           services.webservice.rspread.GetCampaignAbusesResponseGetCampaignAbusesResult getCampaignAbusesResult) {
     ...
     */
    public services.webservice.rspread.GetCampaignAbusesResponseGetCampaignAbusesResult getGetCampaignAbusesResult() {
        return getCampaignAbusesResult;
    }
     ...
     */
    public void setGetCampaignAbusesResult(services.webservice.rspread.GetCampaignAbusesResponseGetCampaignAbusesResult getCampaignAbusesResult) {
        this.getCampaignAbusesResult = getCampaignAbusesResult;
    }
