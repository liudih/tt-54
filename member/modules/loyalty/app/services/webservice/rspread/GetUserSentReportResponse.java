...
public class GetUserSentReportResponse  implements java.io.Serializable {
    private services.webservice.rspread.GetUserSentReportResponseGetUserSentReportResult getUserSentReportResult;

    public GetUserSentReportResponse() {
    }

    public GetUserSentReportResponse(
           services.webservice.rspread.GetUserSentReportResponseGetUserSentReportResult getUserSentReportResult) {
     ...
     */
    public services.webservice.rspread.GetUserSentReportResponseGetUserSentReportResult getGetUserSentReportResult() {
        return getUserSentReportResult;
    }
     ...
     */
    public void setGetUserSentReportResult(services.webservice.rspread.GetUserSentReportResponseGetUserSentReportResult getUserSentReportResult) {
        this.getUserSentReportResult = getUserSentReportResult;
    }
