...
public class ServiceSoapProxy implements services.webservice.rspread.ServiceSoap {
  private String _endpoint = null;
  private services.webservice.rspread.ServiceSoap serviceSoap = null;
  ...
  private void _initServiceSoapProxy() {
    try {
      serviceSoap = (new services.webservice.rspread.ServiceLocator()).getServiceSoap();
      if (serviceSoap != null) {
        if (_endpoint != null)
  ...
  public services.webservice.rspread.ServiceSoap getServiceSoap() {
    if (serviceSoap == null)
      _initServiceSoapProxy();
    return serviceSoap;
  }
