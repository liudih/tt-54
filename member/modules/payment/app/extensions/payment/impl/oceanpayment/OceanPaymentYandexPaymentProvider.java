...
public class OceanPaymentYandexPaymentProvider implements IPaymentProvider {
	...
	public String iconUrl() {
		return controllers.payment.impl.routes.Assets.at(
				"/images/payment04.png").url();
	}

	@Override
	public Html getDescription(PaymentContext context) {
		if (context == null || context.isModeNew()) {
			return views.html.payment.oceanpayment.v2.yandex_description
					.render();
		} else {
			return views.html.payment.oceanpayment.yandex_description.render();
		}
	...
	private LinkedHashMap<String, String> parseToForm(Order order,
			LinkedHashMap<String, String> account, List<OrderDetail> list,
			String backUrl) {
