...
public interface OrderMapper {
	...
	@Select({
			"<script>",
			"select count(*) count,sum(o.fgrandtotal/r.frate) sumTotal,istatus status,",
			"to_char(o.dcreatedate,'yyyy-MM-dd') createdate",
			" from t_order o INNER JOIN t_order_currency_rate r on o.cordernumber = r.cordernumber where 1=1  ",
