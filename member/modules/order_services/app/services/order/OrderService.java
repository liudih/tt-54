...
public class OrderService implements IOrderService {
	...
	public Order createOrderInstance(CreateOrderRequest request) {
		...
		Double freight = getDoubleFreight(weight, shippingWeight,
				shippingMethod, country, subTotal, request.getCurrency(),
				request.getSiteId(), listingIds);
		...
		if (!checkShippingMethodCorrect(shippingStorage.getIid(),
				country.getCshortname(), request.getShippingMethodId(), weight,
				subTotal, listingIds, request.getCurrency(),
				request.getLangID())) {
			Logger.error(
					"OrderService checkShippingMethodCorrect error: "
							+ "storageId: {}, country: {}, shippingMethodId: {}, weight: {}",
		...
		Double finalTotal = checkoutService.sum(items, shippingMethod, country,
	...
	public List<OrderReportForm> getOrderReport(Date startdate, Date enddate,
			String type, int iwebsiteid) {
		return orderMapper.getOrderReport(startdate, enddate, type, iwebsiteid);
	}
	/**
	 * 生成订单号
	 */
	...
	@Override
	public List<String> getHostBySite(int arg0) {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public List<OrderReportForm> getOrderReport(Date arg0, Date arg1,
			String arg2, int arg3, String arg4) {
		// TODO Auto-generated method stub
		return null;
	}
}
