...
lazy val mobile = (project in file("modules/mobile"))
    .enablePlugins(PlayJava)
	.dependsOn( base, member, interaction,messaging,loyalty,advertising_services, paypal,email)
	.dependsOn(testsupport % "test")
...
lazy val root = (project in file("."))
		...
		facebook, paypal, tracking,google, shareasale, messaging, twitter, livechat,mobile,base_services, wholesale,product_services,
