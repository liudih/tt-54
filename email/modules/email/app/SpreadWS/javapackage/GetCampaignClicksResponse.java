...
public class GetCampaignClicksResponse  implements java.io.Serializable {
    private SpreadWS.javapackage.GetCampaignClicksResponseGetCampaignClicksResult getCampaignClicksResult;

    public GetCampaignClicksResponse() {
    }

    public GetCampaignClicksResponse(
           SpreadWS.javapackage.GetCampaignClicksResponseGetCampaignClicksResult getCampaignClicksResult) {
     ...
     */
    public SpreadWS.javapackage.GetCampaignClicksResponseGetCampaignClicksResult getGetCampaignClicksResult() {
        return getCampaignClicksResult;
    }
     ...
     */
    public void setGetCampaignClicksResult(SpreadWS.javapackage.GetCampaignClicksResponseGetCampaignClicksResult getCampaignClicksResult) {
        this.getCampaignClicksResult = getCampaignClicksResult;
    }
