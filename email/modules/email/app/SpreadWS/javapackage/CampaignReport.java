...
public class CampaignReport  implements java.io.Serializable {
    ...
    private SpreadWS.javapackage.CampaignStatus status;
    ...
    public CampaignReport(
           ...
           SpreadWS.javapackage.CampaignStatus status,
     ...
     * @return status
     */
    public SpreadWS.javapackage.CampaignStatus getStatus() {
        return status;
    }
     ...
     * @param status
     */
    public void setStatus(SpreadWS.javapackage.CampaignStatus status) {
        this.status = status;
    }
