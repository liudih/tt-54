...
public class GetSubscriptionResponse  implements java.io.Serializable {
    private SpreadWS.javapackage.GetSubscriptionResponseGetSubscriptionResult getSubscriptionResult;

    public GetSubscriptionResponse() {
    }

    public GetSubscriptionResponse(
           SpreadWS.javapackage.GetSubscriptionResponseGetSubscriptionResult getSubscriptionResult) {
     ...
     */
    public SpreadWS.javapackage.GetSubscriptionResponseGetSubscriptionResult getGetSubscriptionResult() {
        return getSubscriptionResult;
    }
     ...
     */
    public void setGetSubscriptionResult(SpreadWS.javapackage.GetSubscriptionResponseGetSubscriptionResult getSubscriptionResult) {
        this.getSubscriptionResult = getSubscriptionResult;
    }
