...
import valueobjects.base.HtmlMiscNew;
...
public class HtmlUtils {
	...
	public static HtmlMiscNew misc() {
	...
	public static HtmlMiscNew misc(Context context) {
		HtmlMiscNew misc = (HtmlMiscNew) context.args.get(ARGS_NAME);
		if (misc == null) {
			misc = new HtmlMiscNew();
