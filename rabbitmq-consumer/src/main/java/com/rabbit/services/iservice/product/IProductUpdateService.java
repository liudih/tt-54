...
public interface IProductUpdateService {
	...
	public abstract String createProduct(ProductBack pitem, String username)
			throws Exception;

	public abstract void delete(String listingId, String psku, String sku);

	public abstract Boolean saveProductBase(ProductBack pitem, String username,
			String listingid);

	public abstract Boolean saveProductUrl(ProductBack pitem, String username,
			String listingid);
	...
	public abstract String saveProductPromotions(
			List<PromotionPrice> ProductPromotionlist,
			String user);
	...
	public abstract String saveProductCategory(String sku, String categoryPath,
			int websiteid);
	public abstract String saveProductCategoryNew(String sku, List<Integer> categoryIds,
			int websiteid);
	...
	public abstract String addProductMultiAttribute(Boolean mainSku, String sku,
