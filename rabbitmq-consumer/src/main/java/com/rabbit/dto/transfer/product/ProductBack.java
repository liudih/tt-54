...
public class ProductBack {
	...
	public Boolean getIsAllFreeShipping() {
		return isAllFreeShipping;
	}

	public void setIsAllFreeShipping(Boolean isAllFreeShipping) {
		this.isAllFreeShipping = isAllFreeShipping;
	}
