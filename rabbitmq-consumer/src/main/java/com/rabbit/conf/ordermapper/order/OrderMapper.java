...
import com.rabbit.dto.order.DropShipOrderMessage;
import com.rabbit.dto.order.Order;
import com.rabbit.dto.order.OrderApiVo;
import com.rabbit.dto.order.OrderCommission;
import com.rabbit.dto.order.OrderDetail;
import com.rabbit.dto.order.OrderIdStatusId;
import com.rabbit.dto.order.OrderWithDtail;
...
public interface OrderMapper {
	 ...
	 * @return
	 */
	int changeOrdeStatusAndTransactionInfo(Map<String, Object> paras);
	 ...
	 * @return 更新操作影响行数
	 */
	int update(Map<String, Object> paras);
