...
public class ReflectionUtils {
     ...
     *            分隔符.
     */
    public static String fetchElementPropertyToString(final Collection<Object> collection, final String propertyName, final String separator) throws Exception {
