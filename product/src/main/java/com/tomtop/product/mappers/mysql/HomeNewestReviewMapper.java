...
public interface HomeNewestReviewMapper {
	@Select({
			"select review_content,title,listing_id,sku, review_by, country ",
	...
	@Results({
			...
			@Result(column = "review_content", property = "reviewContent", jdbcType = JdbcType.VARCHAR),
			@Result(column = "review_by", property = "reviewBy", jdbcType = JdbcType.VARCHAR),
