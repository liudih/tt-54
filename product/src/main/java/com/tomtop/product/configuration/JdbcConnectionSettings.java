...
public class JdbcConnectionSettings extends AbstractSettings {
	...
	private String wholesaleUsername;
	private String wholesalePassword;
	...
	public void setWholesaleUrl(String wholesaleUrl) {
		this.wholesaleUrl = wholesaleUrl;
	}


	public String getWholesaleUsername() {
		return wholesaleUsername;
	}


	public void setWholesaleUsername(String wholesaleUsername) {
		this.wholesaleUsername = wholesaleUsername;
	}


	public String getWholesalePassword() {
		return wholesalePassword;
	}


	public void setWholesalePassword(String wholesalePassword) {
		this.wholesalePassword = wholesalePassword;
	}
}
