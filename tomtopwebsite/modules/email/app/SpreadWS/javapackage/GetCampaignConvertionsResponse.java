...
public class GetCampaignConvertionsResponse  implements java.io.Serializable {
    private SpreadWS.javapackage.GetCampaignConvertionsResponseGetCampaignConvertionsResult getCampaignConvertionsResult;

    public GetCampaignConvertionsResponse() {
    }

    public GetCampaignConvertionsResponse(
           SpreadWS.javapackage.GetCampaignConvertionsResponseGetCampaignConvertionsResult getCampaignConvertionsResult) {
     ...
     */
    public SpreadWS.javapackage.GetCampaignConvertionsResponseGetCampaignConvertionsResult getGetCampaignConvertionsResult() {
        return getCampaignConvertionsResult;
    }
     ...
     */
    public void setGetCampaignConvertionsResult(SpreadWS.javapackage.GetCampaignConvertionsResponseGetCampaignConvertionsResult getCampaignConvertionsResult) {
        this.getCampaignConvertionsResult = getCampaignConvertionsResult;
    }
