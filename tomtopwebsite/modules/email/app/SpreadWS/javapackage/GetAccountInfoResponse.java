...
public class GetAccountInfoResponse  implements java.io.Serializable {
    private SpreadWS.javapackage.GetAccountInfoResponseGetAccountInfoResult getAccountInfoResult;

    public GetAccountInfoResponse() {
    }

    public GetAccountInfoResponse(
           SpreadWS.javapackage.GetAccountInfoResponseGetAccountInfoResult getAccountInfoResult) {
     ...
     */
    public SpreadWS.javapackage.GetAccountInfoResponseGetAccountInfoResult getGetAccountInfoResult() {
        return getAccountInfoResult;
    }
     ...
     */
    public void setGetAccountInfoResult(SpreadWS.javapackage.GetAccountInfoResponseGetAccountInfoResult getAccountInfoResult) {
        this.getAccountInfoResult = getAccountInfoResult;
    }
