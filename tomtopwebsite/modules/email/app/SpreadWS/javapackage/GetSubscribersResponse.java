...
public class GetSubscribersResponse  implements java.io.Serializable {
    private SpreadWS.javapackage.GetSubscribersResponseGetSubscribersResult getSubscribersResult;

    public GetSubscribersResponse() {
    }

    public GetSubscribersResponse(
           SpreadWS.javapackage.GetSubscribersResponseGetSubscribersResult getSubscribersResult) {
     ...
     */
    public SpreadWS.javapackage.GetSubscribersResponseGetSubscribersResult getGetSubscribersResult() {
        return getSubscribersResult;
    }
     ...
     */
    public void setGetSubscribersResult(SpreadWS.javapackage.GetSubscribersResponseGetSubscribersResult getSubscribersResult) {
        this.getSubscribersResult = getSubscribersResult;
    }
