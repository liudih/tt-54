...
public class GetCampaignUnsubscribesResponse  implements java.io.Serializable {
    private services.webservice.rspread.GetCampaignUnsubscribesResponseGetCampaignUnsubscribesResult getCampaignUnsubscribesResult;

    public GetCampaignUnsubscribesResponse() {
    }

    public GetCampaignUnsubscribesResponse(
           services.webservice.rspread.GetCampaignUnsubscribesResponseGetCampaignUnsubscribesResult getCampaignUnsubscribesResult) {
     ...
     */
    public services.webservice.rspread.GetCampaignUnsubscribesResponseGetCampaignUnsubscribesResult getGetCampaignUnsubscribesResult() {
        return getCampaignUnsubscribesResult;
    }
     ...
     */
    public void setGetCampaignUnsubscribesResult(services.webservice.rspread.GetCampaignUnsubscribesResponseGetCampaignUnsubscribesResult getCampaignUnsubscribesResult) {
        this.getCampaignUnsubscribesResult = getCampaignUnsubscribesResult;
    }
