...
public class SendBatchResponse  implements java.io.Serializable {
    private services.webservice.rspread.Server sendBatchResult;

    public SendBatchResponse() {
    }

    public SendBatchResponse(
           services.webservice.rspread.Server sendBatchResult) {
     ...
     */
    public services.webservice.rspread.Server getSendBatchResult() {
        return sendBatchResult;
    }
     ...
     */
    public void setSendBatchResult(services.webservice.rspread.Server sendBatchResult) {
        this.sendBatchResult = sendBatchResult;
    }
