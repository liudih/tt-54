...
public class GetSubscribers  implements java.io.Serializable {
    ...
    private services.webservice.rspread.SubscriberStatus status;
    ...
    public GetSubscribers(
           ...
           services.webservice.rspread.SubscriberStatus status) {
     ...
     * @return status
     */
    public services.webservice.rspread.SubscriberStatus getStatus() {
        return status;
    }
     ...
     * @param status
     */
    public void setStatus(services.webservice.rspread.SubscriberStatus status) {
        this.status = status;
    }
