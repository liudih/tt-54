...
public class CreateCampaign2Serialize  implements java.io.Serializable {
    ...
    private services.webservice.rspread.CampaignStatus campaignStatus;
    ...
    public CreateCampaign2Serialize(
           ...
           services.webservice.rspread.CampaignStatus campaignStatus) {
     ...
     */
    public services.webservice.rspread.CampaignStatus getCampaignStatus() {
        return campaignStatus;
    }
     ...
     */
    public void setCampaignStatus(services.webservice.rspread.CampaignStatus campaignStatus) {
        this.campaignStatus = campaignStatus;
    }
