...
public class GetUserCredit  implements java.io.Serializable {
    ...
    private services.webservice.rspread.AccountType accountType;
    ...
    public GetUserCredit(
           ...
           services.webservice.rspread.AccountType accountType) {
     ...
     * @return accountType
     */
    public services.webservice.rspread.AccountType getAccountType() {
        return accountType;
    }
     ...
     * @param accountType
     */
    public void setAccountType(services.webservice.rspread.AccountType accountType) {
        this.accountType = accountType;
    }
