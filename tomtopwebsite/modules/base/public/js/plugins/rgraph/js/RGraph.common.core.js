    ...
    RG.att = function (ca)
    {
        ...
        (function (c)
        {
            ...
            if(!c.l && a){
                ...
                $l = $('<a id="rgraphAttribution_' + c.id + '" href="http://www.rgraph.net" style="right: 2px; bottom: 3px; position: absolute; outline: none; text-decoration: none; font-size: 10px; font-family: Arial;color: #666" target="_blank">RGraph.net</a>');
                $l[0].container = $d[0];
                $d[0].link = $l[0];
                c.__link__ = $l[0];
