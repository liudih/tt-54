...
public class PaymentMenuProvider implements IMemberAccountMenuProvider {

	public static final String ID = "affiliate-payment";
	...
	public Html getMenuItem(String currentMenuID) {
		...
		return views.html.affiliate.menu.payment.render(display, highliht);
	}
