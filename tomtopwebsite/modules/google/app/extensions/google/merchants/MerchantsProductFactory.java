...
public class MerchantsProductFactory {
	...
	public Product create(MerchantsProductDto merchantsProductDto,
		...
		try {
			...
			String offerId=csku+"-"+merchantsProductDto.getCcountrycurrency()+"-"+merchantsProductDto.getClanguage();
...
//								merchantsProductDto.getCcountrycurrency());
						...
						String productUrl = Play.application().configuration()
								.getString("productservice.url");
						String url = productUrl + "/ic/v2/products/"+merchantsProductDto.getClistingid()+"?currency=" + merchantsProductDto.getCcountrycurrency()
								+ "&website=1";
						...
						if (data != null) {
							...
							Logger.debug("update price  information  ! price:"+p);
							Price price = new Price();
							price.setValue(p + "");
							price.setCurrency(merchantsProductDto.getCcountrycurrency());
							product.setPrice(price);
