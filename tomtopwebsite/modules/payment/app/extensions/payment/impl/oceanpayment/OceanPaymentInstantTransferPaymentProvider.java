...
public class OceanPaymentInstantTransferPaymentProvider implements IPaymentProvider {
	...
	public String iconUrl() {
		return controllers.base.routes.Assets.at("images/InstantTransfer.png").url();
	}
	...
	private LinkedHashMap<String, String> parseToForm(Order order,
		...
		form.put("methods", "InstantTransfer");
