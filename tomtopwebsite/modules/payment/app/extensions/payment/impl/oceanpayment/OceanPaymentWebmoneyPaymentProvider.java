...
public class OceanPaymentWebmoneyPaymentProvider implements IPaymentProvider {
	...
	public String iconUrl() {
		return controllers.base.routes.Assets.at("images/webmoney.png").url();
	}
