...
public class OceanPaymentTeleingresoPaymentProvider implements IPaymentProvider {
	...
	public String iconUrl() {
		return controllers.base.routes.Assets.at("images/Teleingreso.png").url();
	}
