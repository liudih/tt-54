...
public class OceanPaymentGiropayPaymentProvider implements IPaymentProvider {
	...
	public String iconUrl() {
		return controllers.base.routes.Assets.at("images/Giropay.png").url();
	}
