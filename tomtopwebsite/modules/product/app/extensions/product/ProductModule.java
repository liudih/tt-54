...
import services.product.impl.DatabaseImageService;
import services.product.impl.FastdfsImageService;
...
public class ProductModule extends ModuleSupport implements MyBatisExtension,
		...
		ISearchExtension, ICamelExtension, ISubscribeExtension,
	...
	public void processConfiguration(MyBatisService service) {
		...
		service.addMapperClass("product",
				mapper.attribute.AttributeKeyMapper.class);
		service.addMapperClass("product",
				mapper.attribute.AttributeKeyNameMapper.class);
		service.addMapperClass("product",
				mapper.attribute.AttributeValueMapper.class);
		service.addMapperClass("product",
				mapper.attribute.AttributeValueNameMapper.class);
	}
	...
	public void configBinderExtras(List<? extends IModule> modules,
		...
		final Multibinder<IImageService> imageService = Multibinder
				.newSetBinder(binder, IImageService.class);

		imageService.addBinding().to(FastdfsImageService.class);
		imageService.addBinding().to(DatabaseImageService.class);
	...
	public List<RouteBuilder> getRouteBuilders() {
		return Lists.newArrayList(new NewArrivalTimerTriggerRouteBuilder(),
				new HomePageShowTimerTriggerRouteBuilder(),
				new CategoryRecommendTimerTrigger());
	}
