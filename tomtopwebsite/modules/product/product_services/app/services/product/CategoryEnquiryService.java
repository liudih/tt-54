...
public class CategoryEnquiryService implements ICategoryEnquiryService {
	...
	public List<ProductCategoryMapper> selectByListingId(String listingid) {
		if(listingid == null || "".equals(listingid)){
			return new ArrayList<ProductCategoryMapper>();
		}
		List<ProductCategoryMapper> pcmList = pcMapper.selectByListingId(listingid);
		if(pcmList == null){
			pcmList = new ArrayList<ProductCategoryMapper>();
		}
		return pcmList;
	}
