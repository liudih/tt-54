...
public class ShortUrlGenerator {
	...
	public static void main(String[] args) {
		...
		String sLongUrl = "http://tecqweqweqweqwewqe11212312312312385321288.shtml"; // 3BD768E58042156E54626860E241E999
	...
	public static String[] shortUrl(String url) {
		...
		byte[] buff= (new String(key +  url)).getBytes();
		try {
			sMD5EncryptResult = Hex.encodeHexString(MessageDigest.getInstance("MD5").digest(
					buff));
